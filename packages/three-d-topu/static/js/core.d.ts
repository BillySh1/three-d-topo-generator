 ...
 * @LastEditTime: 2021-03-31 13:39:43
 */
...
declare function toggleShowChildIns(node: NodeTree): void;
declare function sceneReset(): void;
declare function toggleExpand(tree: any): void;
declare function removeHightNodes(): void;
declare function refreshAllLinks(): void;
declare function outputScene(): void;
export {
  initThreeDTopu,
  sendThis,
  toggleShowText,
