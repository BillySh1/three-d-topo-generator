 ...
 * @LastEditTime: 2021-03-01 15:41:46
 */
import { Log } from '@idg/idg';
import { Dropdown, DropdownItem, DropdownMenu, Icon, Tooltip } from '@idg/iview';
...
export default class TopuBody extends Vue {
  ...
  public created() {
    ...
    this.$nextTick(() => core.sendThis(this, this.allData.nodes, this.allData.links, this.allData.tree));
  }
